...
const renderFixture = `{"render_api":1,"revision":1,"ttl_ms":5000,"target":"left-nav","content":{"kind":"tree","id":"root","children":[{"kind":"branch","id":"b","label":"alpha","children":[{"kind":"item","id":"i","label":"work","status":"running","activation":{"type":"terminal","socket":"/run/g.sock","session":"worker-i"}},{"kind":"item","id":"r","label":"old","status":"done","reaped":true}]}]}}`
